      ...
      <main className={styles.main}>
        ...
        <div className={styles.grid}>
          ...
          {information && information.map((info, index) => {
            if(info.department === "Business" || "Computing"){ //this filters thru the department key in the education.json file. You can add "info.department.toLowerCase()" if you want it to find upper (exact) casing or lower case is okay too.
